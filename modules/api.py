...
class API:
    def __init__(self,):
        ...
        self.api_url = [self.config["API"]["PROXYSCRAPE"], self.config["API"]["IPROYAL"], self.config["API"]["GEONODE"]]
        self.session = requests.Session()

    def fetch_proxies(self, pages=1, output_file="proxies/fetch_proxies.txt"):
